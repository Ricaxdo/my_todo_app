// src/features/todo/AddTaskForm.tsx
...
export default function AddTaskForm({
  ...
  // Clases del slider según prioridad
  ...
  return (
    <form onSubmit={onSubmit} className="relative group">
      ...
      <div className="relative flex items-center gap-3 p-2 bg-card border border-border rounded-xl shadow-2xl transition-all focus-within:ring-1 focus-within:ring-white/20 focus-within:border-white/20">
        ...
        {/* Selector de prioridad con slider animado */}
        <div className="relative flex items-center rounded-full bg-secondary/60 px-1 py-1 min-w-[8rem]">
          {/* Slider de fondo que se mueve */}
          <div
            className={`absolute inset-y-1 left-1 w-1/3 rounded-full bg-background/80 border border-border/60 transition-transform duration-400 ease-out ${sliderPosition}`}
          />
